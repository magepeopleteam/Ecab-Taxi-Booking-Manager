	...
	if ( ! class_exists( 'MPTBM_Style' ) ) {
		class MPTBM_Style {
			...
			public function add_global_style() {
				$default_color   = MPTBM_Function::get_style_settings( 'default_text_color', '#000' );
				$theme_color     = MPTBM_Function::get_style_settings( 'theme_color', '#ef3326' );
				$alternate_color = MPTBM_Function::get_style_settings( 'theme_alternate_color', '#fff' );
				$warning_color   = MPTBM_Function::get_style_settings( 'warning_color', '#E67C30' );
				$default_fs   = MPTBM_Function::get_style_settings( 'default_font_size', '14' ) . 'px';
				$fs_h1        = MPTBM_Function::get_style_settings( 'font_size_h1', '35' ) . 'px';
				$fs_h2        = MPTBM_Function::get_style_settings( 'font_size_h2', '30' ) . 'px';
				$fs_h3        = MPTBM_Function::get_style_settings( 'font_size_h3', '25' ) . 'px';
				$fs_h4        = MPTBM_Function::get_style_settings( 'font_size_h4', '22' ) . 'px';
				$fs_h5        = MPTBM_Function::get_style_settings( 'font_size_h5', '18' ) . 'px';
				$fs_h6        = MPTBM_Function::get_style_settings( 'font_size_h6', '16' ) . 'px';
				$fs_label     = MPTBM_Function::get_style_settings( 'font_size_label', '16' ) . 'px';
				$button_fs    = MPTBM_Function::get_style_settings( 'button_font_size', '16' ) . 'px';
				$button_color = MPTBM_Function::get_style_settings( 'button_color', $alternate_color );
				$button_bg    = MPTBM_Function::get_style_settings( 'button_bg', '#ea8125' );
				$section_bg   = MPTBM_Function::get_style_settings( 'section_bg', '#FAFCFE' );
				?>
				<style>
					:root {
