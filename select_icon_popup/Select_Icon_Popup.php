<?php
	...
	if ( ! class_exists( 'Select_Icon_Popup' ) ) {
		$GLOBALS['call_Input_value_icon_choose_popup'] = false;
		class Select_Icon_Popup {
			public function __construct() {
				add_action( 'admin_enqueue_scripts', array( $this, 'icon_script' ), 90 );
				add_action( 'mp_input_add_icon', array( $this, 'load_icon' ), 10, 2 );
			}
			public function icon_script() {
				//wp_enqueue_style( 'mp_font_awesome','//cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.3/css/all.min.css', array(), $this->version, 'all' );
				wp_enqueue_style( 'select_icon_popup_style', plugin_dir_url( __DIR__ ) . '/select_icon_popup/select_icon_popup.css', array(), time() );
				wp_enqueue_script( 'select_icon_popup_script', plugin_dir_url( __DIR__ ) . '/select_icon_popup/select_icon_popup.js', array(), time(), true );
			}
			...
			public function icon_popup() {
				if ( ! $GLOBALS['call_Input_value_icon_choose_popup'] ) {
														...
														<div class="itemIconArea">
															<?php
																foreach ( $icon['icon'] as $icon => $item ) {
																	?>
																	<div class="iconItem" data-icon-class="<?php echo esc_html( $icon ); ?>" data-icon-name="<?php echo esc_html( $item ); ?>" title="<?php echo esc_html( $item ); ?>">
